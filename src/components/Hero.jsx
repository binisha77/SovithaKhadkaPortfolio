      ...
      >
       ...
       {/* left side content */}
        ...
        <h1 className='text-4xl md:text-6xl font-bold mb-4'>
          Hi,I'm <span className='text-purple'>Sovitha khadka</span>
        </h1>
        <h2 className='text-2xl md:text-4xl font-semibold md-6 *
        typewriter'>Full Stack Developer</h2>
        <p className='text-lg text-gray-300 mb-8'>A passionate web developer who brings ideas to life 
          through clean code, modern design, and responsive,
           user-focused digital experiences</p>
           <div>
            ...
            <a href="#contact" className='px-6 py-3 border-purple-700 rounded-lg font-medium
